...
<pre style="position: relative;"><strong>Input:</strong> root = [1,10,4,3,null,7,9,12,8,6,null,null,2]
...
<pre style="position: relative;"><strong>Input:</strong> root = [5,4,2,3,3,7]
...
<pre style="position: relative;"><strong>Input:</strong> root = [5,9,1,3,5,7]
<strong>Output:</strong> false
